...
<div class="row">
    <div class="columns large-12">
        <p><a href="https://book.cakephp.org/3.0/en/core-libraries/inflector.html" target="_blank">Inflector Rules</a></p>
        <p>Inflector: <?= Cake\Utility\Inflector::singularize("grupos") ?></p>
    </div>    
</div>
<div class="row">
