...
class CuentasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cuenta' => ['type' => 'string', 'length' => 8, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'cuentas_unq_cuenta' => ['type' => 'unique', 'columns' => ['cuenta'], 'length' => []],
